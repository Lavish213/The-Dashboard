  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 4px 6px -1px rgb(0 0 0 / 0.5), 0 2px 4px -2px rgb(0 0 0 / 0.4)',
        'elevated': '0 4px 16px 0 rgb(0 0 0 / 0.5)',
        'modal': '0 24px 48px 0 rgb(0 0 0 / 0.6)',
        'tooltip': '0 4px 8px 0 rgb(0 0 0 / 0.5)',
      },
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
